...
<body background="/airline/images/imag.jpg" style="height:100vh;width:100%" alt="NA"/>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
      ...
      %>
        ...
        <li class="nav-item">
          <a class="nav-link" href="/airline/admin/feedbacks.jsp">Feedback</a>
        </li>        
       <%
       ...
       <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/airline/feedback.jsp">FeedBacks</a>
        </li>
        <li class="nav-item">
